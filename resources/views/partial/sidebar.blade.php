<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('toko.index') }}"><i class="fa fa-cube"></i> <span>Toko</span></a></li>
        <li><a href="#"><i class="fa fa-cubes"></i> <span>Produk</span></a></li>
        <li><a href="#"><i class="fa fa-id-card"></i> <span>Member</span></a></li>
        <li><a href="#"><i class="fa fa-users"></i> <span>Costumer</span></a></li>

        <li class="header">TRANSAKSI</li>
        <li><a href="#"><i class="fa fa-download"></i> <span>Pengeluaran</span></a></li>
