...
<head>
    ...
    <!--Page title-->
    <title>Kopiku Admin - @yield('title')</title>
    <!--bootstrap-->
    ...
    <link rel="stylesheet" href="{{ asset('panel/assets/plugins/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
...
<body id="page-top">
    ...
    {{-- datatable --}}
    <script src="{{ asset('panel/assets/plugins/datatables.net/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('panel/assets/plugins/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
