  ...
  <header class="header_area">
    ...
    <div class="sidebar_logo">
        <a href="index.html">
<img src="{{ asset('panel/assets/images/kedai-text.png') }}" style="height: 65px; margin-left: 30px;" alt="" class="img-fluid logo1">
    ...
    <ul class="header_menu">
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    <div class="admin">
                        <a href="#" class="user_link"><img src="{{ asset('panel/assets/images/logo.png') }}" alt=""></a>
                    </div>
                <ul>
